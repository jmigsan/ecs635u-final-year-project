...
public class TESTMicrophoneRecorderToDebugLog : MonoBehaviour
{
    ...
    void StartRecording()
    {
        recordedClip = Microphone.Start(Microphone.devices[0], false, 600, 44100);
        recordingStartTime = Microphone.GetPosition(Microphone.devices[0]);
        isRecording = true;
        Debug.Log("start");
    }
    ...
    void StopRecording()
    {
        ...
        int endTime = Microphone.GetPosition(Microphone.devices[0]);
        isRecording = false;
